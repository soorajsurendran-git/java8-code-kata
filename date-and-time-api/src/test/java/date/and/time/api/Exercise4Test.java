...
public class Exercise4Test {
    ...
    public void zonedDateTimeOf() {
         ...
         */
        ZonedDateTime zonedDateTime = ZonedDateTime.of(LocalDateTime.parse("2015-07-10T02:14:25.00"), ZoneId.of("Asia/Tokyo"));
    ...
    public void zonedDateTimeParse() {
         ...
         */
        ZonedDateTime zonedDateTime = ZonedDateTime.of(LocalDateTime.parse("2015-06-18T23:07:25.000"),
